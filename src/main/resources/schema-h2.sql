...
CREATE TABLE IF NOT EXISTS cards (
    ...
    min_benefit_amount DECIMAL(8,0)
);
...
CREATE TABLE IF NOT EXISTS payments (
    ...
    pos_request_id VARCHAR(64) UNIQUE,
...
CREATE INDEX IF NOT EXISTS idx_payment_tokens_status_expire ON payment_tokens(token_status, expires_at);
CREATE INDEX IF NOT EXISTS idx_payments_card_time ON payments(user_card_id, payment_time);
CREATE INDEX IF NOT EXISTS idx_outbox_retry ON payment_delivery_outbox(delivery_status, next_retry_at);
