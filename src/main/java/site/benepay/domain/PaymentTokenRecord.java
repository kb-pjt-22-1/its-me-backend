...
public class PaymentTokenRecord {
	private long paymentTokenId, userId, userCardId;
	private Long merchantId;
	private BigDecimal expectedAmount;
	private String tokenStatus;
	private LocalDateTime expiresAt, usedAt;

	public long getPaymentTokenId() {
		return paymentTokenId;
	}

	public void setPaymentTokenId(long v) {
		paymentTokenId = v;
	}
	...
	public void setUserCardId(long v) {
		userCardId = v;
	}
	...
	public void setTokenStatus(String v) {
		tokenStatus = v;
	}
