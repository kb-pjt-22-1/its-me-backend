...
public class LoggingAspect {
	...
	private static final String CONTROLLER_METHODS = "site.benepay.common.aop.ControllerPointcuts.controllerMethods()";
	 ...
	 */
	@AfterReturning(pointcut = CONTROLLER_METHODS, returning = "result")
	 ...
	 */
	@AfterThrowing(pointcut = CONTROLLER_METHODS, throwing = "ex")
