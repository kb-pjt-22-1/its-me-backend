...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ErrorResponse> handleInvalidPinFormat(InvalidPinFormatException ex,
		HttpServletRequest request) {
	...
	public ResponseEntity<ErrorResponse> handleUserCardNotAvailable(UserCardNotAvailableException ex,
		HttpServletRequest request) {
		return errorResponse(HttpStatus.BAD_REQUEST, ex.getMessage(), request);
	}
	...
	public ResponseEntity<ErrorResponse> handlePaymentTokenNotUsable(PaymentTokenNotUsableException ex,
		HttpServletRequest request) {
		return errorResponse(HttpStatus.CONFLICT, ex.getMessage(), request);
	}

	@ExceptionHandler(PaymentNotCancelableException.class)
	public ResponseEntity<ErrorResponse> handlePaymentNotCancelable(PaymentNotCancelableException ex,
		HttpServletRequest request) {
		return errorResponse(HttpStatus.CONFLICT, ex.getMessage(), request);
	}
	...
	public ResponseEntity<ErrorResponse> handlePinAlreadyRegistered(PinAlreadyRegisteredException ex,
		HttpServletRequest request) {
		return errorResponse(HttpStatus.CONFLICT, ex.getMessage(), request);
	}
