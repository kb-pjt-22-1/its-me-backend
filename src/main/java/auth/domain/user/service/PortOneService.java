...
import site.benepay.auth.common.exception.PortOneVerificationException;
import site.benepay.auth.common.util.Sha256Util;
import site.benepay.auth.config.PortOneProperties;
...
public class PortOneService {
    ...
    public PortOneService(RestTemplate restTemplate, PortOneProperties portOneProperties,
